...
func (_m *BookService) CreateBatchBooks(_a0 []model.Book) *error.Error {
	ret := _m.Called(_a0)
...
func (_m *BookService) CreateBook(_a0 *model.Book) (*model.Book, *error.Error) {
	ret := _m.Called(_a0)
...
func (_m *BookService) DeleteBookByID(_a0 string) *error.Error {
	ret := _m.Called(_a0)
...
func (_m *BookService) GetAllBooks() ([]model.Book, *error.Error) {
	ret := _m.Called()
...
func (_m *BookService) GetBookByID(_a0 string) (*model.Book, *error.Error) {
	ret := _m.Called(_a0)
...
func (_m *BookService) UpdateBookByID(_a0 string, _a1 *model.Book) (*model.Book, *error.Error) {
